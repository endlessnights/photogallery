...
urlpatterns = [
    ...
    path('back/update_menu_order/', views.update_menu_order, name='update_menu_order'),
    path('back/update_menu_item_name/', views.update_menu_item_name, name='update_menu_item_name'),
